...
summary = result["summary"]
assert summary["comparison_count"] == 17
assert summary["all_within_tolerance"]
assert summary["within_tolerance_count"] == 17
assert summary["scalar_comparison_count"] == 68
assert summary["within_tolerance_scalar_count"] == 68
print("All 68 reported scalars in 17 paper-headline cells are within tolerance")
PY
