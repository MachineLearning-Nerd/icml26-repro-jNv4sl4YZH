...
---
<!-- trackio-cell
{"type": "code", "id": "cell_20d2ff2492ba", "created_at": "2026-07-19T18:54:44+00:00", "title": "Exchangeable and randomized e-merge coverage certificate", "command": ["python", "repro/src/verify_e_merge_coverage.py", "--output", "outputs/claim3_independent_e_merge.json"], "exit_code": 0, "duration_s": 3.735}
-->
````bash
